...
photoSourceURL p sz =
 case photoURL ph of
   ...
   _ ->
     ...
     -- package here...
    "https://farm" ++ fid ++ ".static.flickr.com/" ++ sid ++
    '/':pid ++ '_':sec ++ suff
 where
...
userProfilePageURL u =
  "https://www.flickr.com/people/" ++ userId u ++ "/"

userPhotoStreamURL :: User -> URLString
userPhotoStreamURL u =
  "https://www.flickr.com/photos/" ++ userId u ++ "/"

userPhotoURL :: User -> PhotoID -> URLString
userPhotoURL u pid =
  "https://www.flickr.com/photos/" ++ userId u ++ '/':pid

userPhotosetsURL :: User -> URLString
userPhotosetsURL u =
  "https://www.flickr.com/photos/" ++ userId u ++ "/sets/"

userPhotosetURL :: User -> PhotosetID -> URLString
userPhotosetURL u p =
  "https://www.flickr.com/photos/" ++ userId u ++ "/sets/" ++ p
